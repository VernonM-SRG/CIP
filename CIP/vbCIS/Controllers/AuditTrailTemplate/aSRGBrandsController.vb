...
Namespace Controllers
    Public Class aSRGBrandsController
        ...
        Function Create(<Bind(Include:="SRGBrandID,Name,Shortname,Created,LastModified,RecordStatusCodeID")> ByVal sRGBrand As SRGBrand) As ActionResult
            If ModelState.IsValid Then
                ...
                Dim atr = New AuditTrailRecord("SRGBrand", "Name", "", sRGBrand.Name, "Create", sRGBrand.SRGBrandID)
                Dim savedRecordCount As Integer = 0
                savedRecordCount = savedRecordCount + atr.Insert()
                atr = New AuditTrailRecord("SRGBrand", "Shortname", "", sRGBrand.Shortname, "Create", sRGBrand.SRGBrandID)
                savedRecordCount = savedRecordCount + atr.Insert()
                atr = New AuditTrailRecord("SRGBrand", "RecordStatusCodeID", "", sRGBrand.RecordStatusCodeID, "Create", sRGBrand.SRGBrandID)
                savedRecordCount = savedRecordCount + atr.Insert()
                'VERN: End
        ...
        Function Edit(<Bind(Include:="SRGBrandID,Name,Shortname,Created,LastModified,RecordStatusCodeID")> ByVal sRGBrand As SRGBrand) As ActionResult
            If ModelState.IsValid Then
                ...
                Dim saved As Boolean = AuditTrailRecord.CreateAuditRecord(oldRecord, sRGBrand, "Update", sRGBrand.SRGBrandID, excludedFields)
                tmpDb.Dispose()
                sRGBrand.LastModified = DateTime.Now
                'VERN: end
        ...
        Function DeleteConfirmed(ByVal id As Integer) As ActionResult
            ...
            Dim atr As New AuditTrailRecord("SRGBrand", "RecordStatusCodeID", sRGBrand.RecordStatusCodeID.ToString(), "3", "Delete", sRGBrand.SRGBrandID)
