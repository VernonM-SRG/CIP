...
<div class="nav navbar-nav navbar-inverse navbar-left" style="color: white; position: relative; left: 0px; top: 0; height: 50px; width: 100%;">
    <div class="nav navbar-nav navbar-inverse navbar-left" style="color: white; position: relative; left: 10px; top: 10px; height: 20px;">
        <b class="SRGrightPadding">Insurer</b> <u class="SRGrightPadding">Edit</u> @Html.ActionLink("Create", "Create", routeValues:=Nothing, htmlAttributes:=New With {.class = "SRGNavigationLink SRGrightPadding"}) @Html.ActionLink("Delete", "Delete", New With {.id = Model.InsuranceCompanyID}, htmlAttributes:=New With {.class = "SRGNavigationLink SRGrightPadding"}) @Html.Partial("_LoginRegister")
    </div>
</div>
<div style="position: relative; top: 50px;">
    ...
    @<div class="form-horizontal SRGform">
        ...
        <div class="form-group">
            ...
            @Html.TextAreaFor(Function(model) model.StandardDiscount, New With {.htmlAttributes = New With {.class = "form-control SRGinput"}})
